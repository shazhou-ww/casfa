...
(async () => {
  ...
  body.style.cssText = "margin:0;padding:16px;font-family:system-ui;background:#1a1a2e;color:#eee;";
  ...
  try {
    ...
    for (const name of names) {
      ...
      card.style.cssText = "border-radius:8px;overflow:hidden;background:#16213e;cursor:pointer;";
    ...
    grid.innerHTML = `<p style="color:#e74c3c;">Failed to load target: ${e.message}</p>`;
  }
})();
